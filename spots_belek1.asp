...
<body style="background-color: #35151B">
...
<div align="center">
	<table border="0" style="border-collapse: collapse" class="spots-number" width=70px>
     ...
     s-sql="SELECT 200-sum(belek_acts) as total from reserved_places" 
...
<% end if %>
<%
fp_sQry="SELECT 200-sum(belek_acts) as total from reserved_places"
fp_sDefault=""
