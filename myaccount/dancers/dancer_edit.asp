...
<body topmargin="100" style="background-color: #000000">
  ...
  marginwidth="1" marginheight="0" border="0" frameborder="0">
		...
		<form action="dancer_edit.asp" target="_self">
	<p align="center"><nobr>
...
fp_iRegion=BOTID
%>
<!--webbot bot="DatabaseRegionStart" endspan --><select NAME="dancerID" SIZE="1" class="formfield" style="text-align: center" onchange="submit()">
	...
	<!--webbot bot="DatabaseRegionStart" s-columnnames="dancer_ID,studioID,dancer_fn,dancer_ln,dateofbirth,dd_dob,mm_dob,year_dob,datecreated,lastupdated,duplicates,filler" s-columntypes="3,3,202,202,202,3,3,3,135,135,202,130" s-dataconnection="s4d_2025" b-tableformat="FALSE" b-menuformat="FALSE" s-menuchoice s-menuvalue b-tableborder="FALSE" b-tableexpand="TRUE" b-tableheader="FALSE" b-listlabels="FALSE" b-listseparator="FALSE" i-listformat="0" b-makeform="FALSE" s-recordsource s-displaycolumns="dancer_ID,studioID,dancer_fn,dancer_ln,dateofbirth,dd_dob,mm_dob,year_dob,datecreated,lastupdated,duplicates,filler" s-criteria s-order s-sql="SELECT * FROM dancers where dancer_ID=::dancerID::" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="dancerID=0" s-norecordsfound i-maxrecords="1" i-groupsize="0" botid="4" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="BODY" preview="&lt;table border=0 width=&quot;100%&quot;&gt;&lt;tr&gt;&lt;td bgcolor=&quot;#FFFF00&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;" startspan --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
document.write("<div style='background: yellow; color: black;'>The Database Results component on this page is unable to display database content. The page must have a filename ending in '.asp', and the web must be hosted on a server that supports Active Server Pages.</div>");
</SCRIPT>
<% end if %>
<%
fp_sQry="SELECT * FROM dancers where dancer_ID=::dancerID::"
fp_sDefault="dancerID=0"
fp_sNoRecords=""
fp_sDataConn="s4d_2025"
fp_iMaxRecords=1
fp_iCommandType=1
...
fp_sMenuChoice=""
fp_sMenuValue=""
fp_sColTypes="&dancer_ID=3&studioID=3&dancer_fn=202&dancer_ln=202&dateofbirth=202&dd_dob=3&mm_dob=3&year_dob=3&datecreated=135&lastupdated=135&duplicates=202&filler=130&"
fp_iDisplayCols=12
fp_fCustomQuery=True
BOTID=4
fp_iRegion=BOTID
...
<!--webbot bot="DatabaseRegionStart" endspan --><p>
	<!--webbot bot="DatabaseResultColumn" s-columnnames="dancer_ID,studioID,dancer_fn,dancer_ln,dateofbirth,dd_dob,mm_dob,year_dob,datecreated,lastupdated,duplicates,filler" s-column="dancer_ID" b-tableformat="FALSE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;dancer_ID&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><!--webbot bot="DatabaseResultColumn" endspan --></p>
	<div align="center">
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="update_dancer.asp" name="FrontPage_Form2"
   ...
   language="JavaScript" target="I18">
     ...
     maxlength="50" value="<%=FP_FieldHTML(fp_rs,"dancer_fn")%>"
     onblur="changetoproper(fname);duplicates.value=studioID.value+'/'+fname.value+surname.value+'/'+dateofbirth.value" ><p align="center" 
     style="margin-top: 6px; margin-bottom: 6px">
					&nbsp;<!--webbot bot="Validation" s-display-name="Surname" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="50" --><input type="text" name="surname" size="30" value="<%=FP_FieldHTML(fp_rs,"dancer_ln")%>"
      class="formfield" placeholder="Surname" 
      onblur="changetoupper(surname);duplicates.value=studioID.value+'/'+fname.value+surname.value+'/'+dateofbirth.value" 
     ...
     size="2">&nbsp;to unlock/lock</font></a></p>
					...
					<input type="hidden" name="duplicates" value="<%=FP_FieldVal(fp_rs,"duplicates")%>">
					<input type="hidden" name="studioID" value="<%=Server.HtmlEncode(Request("studioID0"))%>">  
          <input type="hidden" name="dd" value="<%=FP_FieldVal(fp_rs,"dd_dob")%>">
          <input type="hidden" name="mm" value="<%=FP_FieldVal(fp_rs,"mm_dob")%>">
          <input type="hidden" name="yyyy" value="<%=FP_FieldVal(fp_rs,"year_dob")%>">
          <input type="hidden" name="fileID" value="<%=FP_FieldVal(fp_rs,"dancer_ID")%>">
...
function myFunc1()
{
  {document.getElementById("mySubmit").disabled = false;document.getElementById("mySubmit").value="Edit Dancer";document.getElementById("mySubmit").style.backgroundColor='green';document.getElementById("aaa").value='1';}
}
</script>
...
function myFunc2()
{
  	{document.getElementById("mySubmit").disabled = true;document.getElementById("mySubmit").value="Edit Dancer (Locked)";document.getElementById("mySubmit").style.backgroundColor='red';document.getElementById("aaa").value='0';}
}
</script>
<script>
...
{
  document.getElementById("mySubmit").disabled = true;document.getElementById("mySubmit").value="Edit Dancer (Locked)";document.getElementById("mySubmit").style.backgroundColor='red';document.getElementById('actdivID').disabled=true;
}
