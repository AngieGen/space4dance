...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="update_studio_profile.asp" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
	<div align="center">
...
<!--webbot bot="DatabaseRegionStart" endspan --><p style="margin-top: 0; margin-bottom: 0">
					...
					<font face="Bahnschrift" size="2">Update Studio Profile</font></p>
					<p style="margin-top: 6px; margin-bottom: 6px">
    ...
    tabindex="1" value="<%=FP_FieldHTML(fp_rs,"studioname")%>"></p>
			<p style="margin-top: 6px; margin-bottom: 6px">
					<!--webbot bot="Validation" s-display-name="Studio Name" 
     b-value-required="TRUE" i-minimum-length="1" 
     i-maximum-length="50" --><input type="text" 
    ...
    onblur="changetoupper(city)" value="<%=FP_FieldHTML(fp_rs,"city")%>"></p>
			<p style="margin-top: 6px; margin-bottom: 6px">
					<select size="1" name="countryID" class="formfield" 
     tabindex="3">
					<option value="<%=FP_FieldHTML(fp_rs,"countryID")%>"><%=FP_FieldHTML(fp_rs,"name")%></option>
          <option value="60">Denmark</option>
			...
			<p style="margin-top: 6px; margin-bottom: 6px">
					<input type="text" 
    placeholder="Instagram" class="formfield" name="instagram" 
    size="20" maxlength="50" 
    tabindex="4" value="<%=FP_FieldHTML(fp_rs,"instagram")%>"></p>
			<p style="margin-top: 6px; margin-bottom: 6px">
					change pin code if you wish</p>
              <p align="center" style="margin-top: 6px; margin-bottom: 6px"><nobr>
				<!--webbot bot="Validation" s-display-name="Log In Code" 
    s-data-type="Integer" s-number-separators="x" 
    b-value-required="TRUE" i-minimum-length="6" i-maximum-length="6" 
    s-validation-constraint="Greater than or equal to" 
    s-validation-value="1" 
    s-validation-constraint="Less than or equal to" 
    s-validation-value="1000000" --><input type="password" id="pincode" 
    onfocus="myFunction(bbb);clearbox(this)" name="pincode" 
    placeholder="Create a 6-digits Log In code" class="formfield" 
    size="20" value="<%=FP_FieldHTML(fp_rs,"pincode")%>" tabindex="5" maxlength="6" 
