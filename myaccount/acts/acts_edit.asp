...
<body topmargin="100" style="background-color: #000000">
  <div align="center"><p></div>
	...
	<div align="center">
		<iframe name="I18" src="blank_act_edit.asp" height="170" 
  marginwidth="1" marginheight="0" border="0" frameborder="0" width="981">
...
<% end if %>
<%
fp_sQry="select act_ID, actname+' ('+eventname+')' as actname from acts where eventID>9 and (studioID = ::studioID0:: or act_ID=::Act_ID::) order by actname ASC"
...
<table border="0" style="border-collapse: collapse">
	...
	<!--webbot bot="DatabaseRegionStart" s-columnnames="act_ID,eventID,eventname,studioID,teamname,choreographer,actname,act_format,act_type,comp_numbers,act_nomination,act_agegroup,act_division,act_min_age,act_max_age,act_duration,mixed,mixedage,music_on_entry,notes,sound_link,background_link,combined,datecreated,lastupdated,duplicates,fee,fees,filler" s-columntypes="3,3,202,3,202,202,202,130,3,3,202,130,130,3,3,130,11,130,202,203,201,201,11,135,135,202,3,3,130" s-dataconnection="s4d_2025" b-tableformat="FALSE" b-menuformat="FALSE" s-menuchoice="act_ID" s-menuvalue="act_ID" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="FALSE" s-recordsource s-displaycolumns="act_ID,eventID,eventname,studioID,teamname,choreographer,actname,act_format,act_type,comp_numbers,act_nomination,act_agegroup,act_division,act_min_age,act_max_age,act_duration,mixed,mixedage,music_on_entry,notes,sound_link,background_link,combined,datecreated,lastupdated,duplicates,fee,fees,filler" s-criteria s-order s-sql="SELECT * FROM acts where act_ID=::ActID::" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="ActID=0" s-norecordsfound="No records returned ~ select the Act you wish to Update" i-maxrecords="1" i-groupsize="0" botid="2" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="BODY" preview="&lt;table border=0 width=&quot;100%&quot;&gt;&lt;tr&gt;&lt;td bgcolor=&quot;#FFFF00&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;" b-InForm="TRUE" b-UseDotNET="FALSE" CurrentExt sa-InputTypes b-DataGridFormat="FALSE" b-DGridAlternate="TRUE" sa-CritTypes b-WasTableFormat="FALSE" startspan b-ReplaceDatabaseRegion="FALSE" --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
document.write("<div style='background: yellow; color: black;'>The Database Results component on this page is unable to display database content. The page must have a filename ending in '.asp', and the web must be hosted on a server that supports Active Server Pages.</div>");
</SCRIPT>
...
<!--webbot bot="DatabaseRegionStart" endspan --><p style="margin-top: 3px; margin-bottom: 3px">
	...
	<p style="margin-top: 3px; margin-bottom: 3px">
					<select  onfocus="mychkfield()" size="1" name="act_division" id="actdivID" class="formfield" tabindex="10" onblur="division2.value=this.value;updateOptionsWOD();updateAgegroupsWOD();updateNominationsWOD();">
	...
	<p style="margin-top: 3px; margin-bottom: 3px">
    <select  onfocus="chkfield()"  id="formatID" name="act_format" class="formfield" size="1" tabindex="5" onblur="if(this.value=='SOLO'){fee.value='60';} if(this.value=='DUO'){fee.value='45';} if(this.value=='GROUP'){fee.value='25'}">
    ...
    placeholder="Number of Competitors in this Act" tabindex="6" onblur="fees.value=fee.value*this.value"
   ...
   tabindex="12">
    ...
    <input type="hidden" name="fee" value="<%=FP_FieldHTML(fp_rs,"fee")%>">
    <input type="hidden" name="fees" value="<%=FP_FieldHTML(fp_rs,"fees")%>">
