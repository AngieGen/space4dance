...
<% end if %>
<%
fp_sQry="select act_ID, actname+' ('+eventname+')' as actname from acts where  studioID = ::studioID0:: and eventID=9 or act_ID=::Act_ID:: and eventID=9 order by actname ASC"
...
<!--webbot bot="DatabaseRegionStart" endspan --><!--webbot bot="Validation" s-display-name="Select Act" b-value-required="TRUE" b-disallow-first-item="TRUE" --><select NAME="actID" SIZE="1" class="div1" onchange="submit()" style="color: #FF0000; text-transform: uppercase; font-family: Bahnschrift; font-size: 10pt; text-align:center">
	<option value="Select Act to Add Sound Track">Select Act for media file upload
	</option>
...
<% end if %>
<%
fp_sQry="select act_ID, actname, combined from acts where act_ID=::ActID:: order by actname ASC"
fp_sDefault="ActID=0"
fp_sNoRecords=""
fp_sDataConn="s4d_2025"
fp_iMaxRecords=0
...
fp_sMenuValue="act_ID"
fp_sColTypes="&act_ID=3&actname=202&combined=11&"
fp_iDisplayCols=3
fp_fCustomQuery=True
BOTID=4
fp_iRegion=BOTID
...
<!--webbot bot="DatabaseRegionStart" endspan --><p align="center">
	...
	ACT NAME =
	<!--webbot bot="DatabaseResultColumn" s-columnnames="act_ID,actname,combined" s-column="actname" b-tableformat="FALSE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;actname&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"actname")%><!--webbot bot="DatabaseResultColumn" endspan --></font></p>
...
<!--webbot bot="DatabaseRegionEnd" endspan --><input type="hidden" name="studioID0"  value="<%=Server.HtmlEncode(Request("studioID0"))%>"><input type="hidden" name="Act_ID" value="<%=Server.HtmlEncode(Request("ActID"))%>"></form>
  ...
  <form method="POST" action="update_sound_link.asp" target="I17" name="form2">
	<div align="center">
	<table border="0" style="border-collapse: collapse" width="100%">
		<tr>
			<td>
			<p align="center">
			<iframe name="I17" src="sound_blank.asp" marginwidth="1" 
   ...
   frameborder="0" target="I13">
    ...
    <p>
			...
			<td align="center">
			<p style="margin-top: 6px; margin-bottom: 6px"><input type="text" name="file_link" id="link" size="20" class="div1"><p style="margin-top: 6px; margin-bottom: 6px">
			&nbsp;</td>
		</tr>
		<tr>
			<td align="center">
  ...
  <input type="hidden" name="combined" value="0">
	</form>
  <script>
function myFunc1()
{
