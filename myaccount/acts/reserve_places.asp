...
method="POST" action="update_places.asp" target="I17">
  ...
  class="div2">
			...
			<tr>
				<td height="80">Europestage Riga ~ 01 March 2026 ~ places are 
				now full but you may still apply for the waiting list</td>
    ...
    value="<%=FP_FieldHTML(fp_rs,"belek_dancers")%>" tabindex="4"></td>
			...
			<tr>
				<td height="80">World of Dance Latvia, Riga ~ 23 May 2026</td>
				<td align="center" height="80"><!--webbot bot="Validation" 
    s-display-name="WOD Acts" s-data-type="Integer" 
    s-number-separators="x" --><input type="number" name="wod_acts" size="20" onblur="if(this.value!=<%=FP_FieldHTML(fp_rs,"wod_acts")%>) {wod_changed.value=<%=FP_FieldHTML(fp_rs,"wod_changed")%>+1} else {wod_changed.value=<%=FP_FieldHTML(fp_rs,"wod_changed")%>}"
    class="formfield2" style="text-align: center" 
    value="<%=FP_FieldHTML(fp_rs,"wod_acts")%>" tabindex="5"></td>
				<td align="center" height="80"><!--webbot bot="Validation" 
    s-display-name="WOD Competitors" s-data-type="Integer" 
    s-number-separators="x" --><input type="number" name="wod_dancers" size="20" onblur="if(this.value!=<%=FP_FieldHTML(fp_rs,"wod_dancers")%>) {wod_changed.value=<%=FP_FieldHTML(fp_rs,"wod_changed")%>+1} else {wod_changed.value=<%=FP_FieldHTML(fp_rs,"wod_changed")%>}"
    class="formfield2" style="text-align: center" 
    value="<%=FP_FieldHTML(fp_rs,"wod_dancers")%>" tabindex="6"></td>
			</tr>
			<tr>
  ...
  <input type="hidden" name="wod_changed" value="<%=FP_FieldHTML(fp_rs,"wod_changed")%>">
