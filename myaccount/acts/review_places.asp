...
<p align="center"><font color="#FF7B00">RESERVE PLACES</font></p>
<p align="center">
...
s-columnnames="reserveID,studioID,riga_acts,riga_dancers,riga_changed,riga_datepaid,riga_money,belek_acts,belek_dancers,belek_changed,belek_datepaid,belek_money,wod_acts,wod_dancers,wod_changed,wod_datepaid,wod_money,lastupdated,eof" 
s-columntypes="3,3,3,3,3,135,6,3,3,3,135,6,3,3,3,135,6,135,130" 
...
s-displaycolumns="reserveID,studioID,riga_acts,riga_dancers,riga_changed,riga_datepaid,riga_money,belek_acts,belek_dancers,belek_changed,belek_datepaid,belek_money,wod_acts,wod_dancers,wod_changed,wod_datepaid,wod_money,lastupdated,eof" 
s-criteria s-order 
s-sql="SELECT * FROM reserved_places where studioID=::studioID0::" 
b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="studioID0=0" 
...
fp_sMenuChoice=""
fp_sMenuValue=""
fp_sColTypes="&reserveID=3&studioID=3&riga_acts=3&riga_dancers=3&riga_changed=3&riga_datepaid=135&riga_money=6&belek_acts=3&belek_dancers=3&belek_changed=3&belek_datepaid=135&belek_money=6&wod_acts=3&wod_dancers=3&wod_changed=3&wod_datepaid=135&wod_money=6&lastupdated=135&eof=130&"
fp_iDisplayCols=19
...
method="POST" action="update_places.asp" target="I17">
	<div align="center">
		<table border="0" style="border-collapse: collapse" width="100%" 
  class="div2">
			<tr>
				<td>Europestage Riga ~ 01 March 2026</td>
				<td align="center">Likely Number of Acts</td>
			</tr>
			<tr>
				<td height="80">Spots are now fully reserved.&nbsp; If you don't 
				need all your reserved places you can free up spaces for others 
				on the waiting list by changing your likely number of acts 
				downwards.&nbsp; It is not possible at this moment in time to 
				increase your original number of places.&nbsp; Also remember we 
				will shortly be asking studios to pay a deposit in line with 
				their confirmed reservations.</td>
				<td align="center" height="80"><!--webbot bot="Validation" 
    s-display-name="ES Belek Acts" s-data-type="Integer" 
    s-number-separators="x" -->
				<input type="number" id="acts" name="riga_acts" size="20" onfocus="this.value=original.value" onblur="if(this.value>original.value) {checknumber()} else {riga_changed.value=<%=FP_FieldHTML(fp_rs,"riga_changed")%>+1}"
    class="formfield2" style="text-align: center" 
    value="<%=FP_FieldHTML(fp_rs,"riga_acts")%>" tabindex="3"></td>
			</tr>
			<tr>
				<td height="80">It would also be helpful if you could indicate 
				the likely number of your acts that fall in the 3-4 &amp; 5-6 age 
				groups in total.</td>
				<td align="center" height="80"><!--webbot bot="Validation" 
    s-display-name="ES Belek Acts" s-data-type="Integer" 
    s-number-separators="x" -->
				<input type="number" name="block1" size="20" class="formfield2" style="text-align: center" 
    value="<%=FP_FieldHTML(fp_rs,"block1")%>" tabindex="3"></td>
			</tr>
			<tr>
	...
	<input type="hidden" name="riga_changed" value="<%=FP_FieldHTML(fp_rs,"riga_changed")%>">
  <input type="hidden" name="aaa" id="aaa" value="0">
	<input type="hidden" name="studioID0" value="<%=FP_FieldHTML(fp_rs,"studioID")%>">
	<input type="hidden" name="original" value="<%=FP_FieldHTML(fp_rs,"riga_acts")%>">
</form>
...
<script>
	...
	{
	alert("You cannot increase your number of reserved acts");
	document.getElementById("acts").focus();
	}
</script>
