...
<p align="center"><font color="#FF7B00">Waiting list for Europestage Riga</font></p>
<p align="center">
...
method="POST" action="update_riga_waiting.asp" target="I17">
	<div align="center">
  ...
  class="div2">
			...
			<tr>
				<td height="80"><font color="#00FF00">Europestage Riga ~ 01 March 2026 ~ places are 
				now full but you may still apply for the waiting list</font></td>
				<td align="center" height="80"><!--webbot bot="Validation" 
    s-display-name="ES Riga Acts" s-data-type="Integer" 
    s-number-separators="x" --><input type="number" name="riga_acts" size="20" onblur="if(this.value!=<%=FP_FieldHTML(fp_rs,"riga_acts")%>) {riga_changed.value=<%=FP_FieldHTML(fp_rs,"riga_changed")%>+1} else {riga_changed.value=<%=FP_FieldHTML(fp_rs,"riga_changed")%>}"
    class="formfield2" style="text-align: center" tabindex="1" 
    value="<%=FP_FieldHTML(fp_rs,"riga_acts")%>"></td>
				<td align="center" height="80"><!--webbot bot="Validation" 
    s-display-name="ES Riga Competitors" s-data-type="Integer" 
    s-number-separators="x" --><input type="number" name="riga_dancers" size="20" onblur="if(this.value!=<%=FP_FieldHTML(fp_rs,"riga_dancers")%>) {riga_changed.value=<%=FP_FieldHTML(fp_rs,"riga_changed")%>+1} else {riga_changed.value=<%=FP_FieldHTML(fp_rs,"riga_changed")%>}"
    class="formfield2" style="text-align: center" 
    value="<%=FP_FieldHTML(fp_rs,"riga_dancers")%>" tabindex="2"></td>
			</tr>
			<tr>
