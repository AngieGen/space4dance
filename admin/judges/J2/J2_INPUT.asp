...
<% end if %>
<%
fp_sQry="select * , (ESstage.program_order-(block*1000)) as program_order from WODscores left join acts on acts.act_ID= WODscores.actID left join studios on studio_ID=studioID left join ESstage on ESstage.actID=WODscores.actID where j2ID=2 AND (statusnumber=::statusnumber:: or ESstage.program_order=::programno::) order by ESstage.program_order DESC"
