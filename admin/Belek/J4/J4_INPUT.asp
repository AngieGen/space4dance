...
<body topmargin="10" bgcolor="#000000">
<form method="POST" action="J4_INPUT.asp?j4ID=4" name="form1" target="_self">
			<div align="center">
				<table border="0" style="border-collapse: collapse" width="100%" class="div2">
					<tr>
						<td width="15%" rowspan="2">
			<a href="J4_INPUT.asp?j4ID=4" target=_self><i class="fa-solid fa-arrows-rotate" style="color: #FF7600"></i></a>
			...
			<p style="margin-top: 0; margin-bottom: 0">
			<!--webbot bot="Validation" s-display-name="Studio Number" s-data-type="Integer" s-number-separators="," --><input type="number" name="programno" size="20" class="div1" style="text-align: center; font-size:10pt; font-family:Trebuchet MS" value="<%=Server.HtmlEncode(Request("programno"))%>" onchange="Submit()"></p>
						</td>
					</tr>
					</table>
				</div>
	...
	<form method="POST" id="j4" action="update_j4_scores.asp" target="I151">
	<input type="hidden" name="j4ID" value="4">	
<div align="center">
...
<!--webbot bot="DatabaseRegionStart" endspan -->
   ...
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j4T"),0)%>" class="div1" 
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j4C"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ><font size="1"> 
			maximum 30</font></td>
			</tr>
		<tr>
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j4P"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ><font size="1"> 
			maximum 20</font></td>
			</tr>
		<tr>
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j4M"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ><font size="1"> 
			maximum 20</font></td>
			</tr>
		<tr>
   ...
   size="6" tabindex="1" maxlength="2" ></td>
		...
		<tr>
				...
				<b>notes</b></font></td>
				<td style="border-style: none; border-width: medium" width="70%" align="left">
			<textarea rows="3" name="notes" cols="20" style="font-family: Bahnschrift; font-size: 10pt" tabindex="5" class="div"><%=FP_FieldVal(fp_rs,"j4notes")%> </textarea></td>
			</tr>
		<tr>
				<td style="border-style: none; border-width: medium" width="30%" align="right">
				&nbsp;</td>
		...
		<tr>
				...
				<a target="_self" href="J4_scores.asp?j4ID=<%=FP_FieldURL(fp_rs,"j1ID")%>&category=<%=FP_FieldURL(fp_rs,"category")%>" style="text-decoration: none"><i class="fa-solid fa-magnifying-glass fa-xl" style="color: #ff7600;"></i>
 ...
 align="center">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe>
		...
		<input type="hidden" name="T51" value="<%=FP_FieldVal(fp_rs,"j4sum")%>">
		<script>
