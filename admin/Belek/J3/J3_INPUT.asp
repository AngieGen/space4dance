...
<form method="POST" action="J3_INPUT.asp?j3ID=3" name="form1" target="_self">
			<div align="center">
				<table border="0" style="border-collapse: collapse" width="100%" class="div2">
					<tr>
						<td width="15%" rowspan="2">
			<a href="J3_INPUT.asp?j3ID=3" target=_self><i class="fa-solid fa-arrows-rotate" style="color: #FF7600"></i></a>
	...
	<form method="POST" id="j3" action="update_j3_scores.asp" target="I151">
	<input type="hidden" name="j3ID" value="3">	
<div align="center">
...
id="es_logo">
   ...
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j3T"),0)%>" class="div1" 
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j3C"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ><font size="1"> 
			maximum 30</font></td>
			</tr>
		<tr>
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j3P"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ><font size="1"> 
			maximum 20</font></td>
			</tr>
		<tr>
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j3M"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ><font size="1"> 
			maximum 20</font></td>
			</tr>
		<tr>
   ...
   size="6" tabindex="1" maxlength="2" ></td>
		...
		<tr>
				...
				<b>notes</b></font></td>
				<td style="border-style: none; border-width: medium" width="70%" align="left">
			<textarea rows="3" name="notes" cols="20" style="font-family: Bahnschrift; font-size: 10pt" tabindex="5" class="div"><%=FP_FieldVal(fp_rs,"j3notes")%> </textarea></td>
			</tr>
		<tr>
				<td style="border-style: none; border-width: medium" width="30%" align="left">
				<a target="_self" href="J3_scores.asp?j3ID=<%=FP_FieldURL(fp_rs,"j3ID")%>&category=<%=FP_FieldURL(fp_rs,"category")%>" style="text-decoration: none"><i class="fa-solid fa-magnifying-glass fa-xl" style="color: #ff7600;"></i>
 ...
 align="center">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe>
		...
		<input type="hidden" name="T51" value="<%=FP_FieldVal(fp_rs,"j3sum")%>">
		<script>
