...
<form method="POST" action="J2_INPUT.asp?j2ID=2" name="form1" target="_self">
			<div align="center">
				<table border="0" style="border-collapse: collapse" width="100%" class="div2">
					<tr>
						<td width="15%" rowspan="2">
			<a href="J2_INPUT.asp?j2ID=2" target=_self><i class="fa-solid fa-arrows-rotate"  style="color: #FF7600"></i></a>
			...
			<p style="margin-top: 0; margin-bottom: 0">
			<font color="#FFFFFF">
			<!--webbot bot="Validation" s-display-name="Studio Number" s-data-type="Integer" s-number-separators="," --><input type="number" name="programno" size="20" class="div1" style="text-align: center; font-size:10pt; font-family:Trebuchet MS" value="<%=Server.HtmlEncode(Request("programno"))%>" onchange="Submit()"></font></p>
						</td>
					</tr>
					</table>
				</div>
	...
	<form method="POST" id="j2" action="update_j2_scores.asp" target="I151">
	<input type="hidden" name="j2ID" value="2">	
<div align="center">
...
<!--webbot bot="DatabaseRegionStart" endspan -->
    ...
    s-columnnames="scoresID,actID,j1ID,j1T,j1C,j1P,j1M,j1sum,j1notes,j1scored,j2ID,j2T,j2C,j2P,j2M,j2sum,j2notes,j2scored,j3ID,j3T,j3C,j3P,j3M,j3sum,j3notes,j3scored,j4ID,j4T,j4C,j4P,j4M,j4sum,j4notes,j4scored,j5ID,j5T,j5C,j5P,j5M,j5sum,j5notes,j5scored,confirmed,posn,posnL,points,max_pts,filler,act_ID,eventID,eventname,studioID,teamname,choreographer,actname,act_format,act_type,comp_numbers,act_nomination,act_agegroup,act_division,act_min_age,act_max_age,act_duration,mixed,mixedage,music_on_entry,notes,sound_link,background_link,combined,datecreated,lastupdated,duplicates,filler,studio_ID,studioname,contact,fname,surname,email,mobile,city,countryID,instagram,pincode,datecreated,lastupdated,ipaddress,sessionID,secureno,duplicates,bulk_link,bulk_uploaded,discount_lv,deposit_lv,discount_tr,deposit_tr,discount_wod,deposit_wod,company_name,invoice_address,company_number,invoice_notes,filler,ESstage_ID,actID,day,starttime,program_order,block,registered,reg_time,act_status,statusnumber,checktimeon,checktimeoff,svrdate,filler,program_order" 
    ...
    bot="DatabaseResultColumn" endspan --></font></b></td>
			...
			<tr>
				...
				<!--webbot bot="DatabaseResultColumn" 
    s-columnnames="scoresID,actID,j1ID,j1T,j1C,j1P,j1M,j1sum,j1notes,j1scored,j2ID,j2T,j2C,j2P,j2M,j2sum,j2notes,j2scored,j3ID,j3T,j3C,j3P,j3M,j3sum,j3notes,j3scored,j4ID,j4T,j4C,j4P,j4M,j4sum,j4notes,j4scored,j5ID,j5T,j5C,j5P,j5M,j5sum,j5notes,j5scored,confirmed,posn,posnL,points,max_pts,filler,act_ID,eventID,eventname,studioID,teamname,choreographer,actname,act_format,act_type,comp_numbers,act_nomination,act_agegroup,act_division,act_min_age,act_max_age,act_duration,mixed,mixedage,music_on_entry,notes,sound_link,background_link,combined,datecreated,lastupdated,duplicates,filler,studio_ID,studioname,contact,fname,surname,email,mobile,city,countryID,instagram,pincode,datecreated,lastupdated,ipaddress,sessionID,secureno,duplicates,bulk_link,bulk_uploaded,discount_lv,deposit_lv,discount_tr,deposit_tr,discount_wod,deposit_wod,company_name,invoice_address,company_number,invoice_notes,filler,ESstage_ID,actID,day,starttime,program_order,block,registered,reg_time,act_status,statusnumber,checktimeon,checktimeoff,svrdate,filler,program_order" 
    s-column="j2sum" b-tableformat="FALSE" b-hashtml="FALSE" 
    b-makelink="FALSE" clientside b-MenuFormat 
    preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;j2sum&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" 
    startspan 
    
    
    s-ColumnTypes="3,3,3,3,3,3,3,3,203,11,3,3,3,3,3,3,203,11,3,3,3,3,3,3,203,11,3,3,3,3,3,3,203,11,3,3,3,3,3,3,203,11,11,3,130,3,3,130,3,3,202,3,202,202,202,130,3,3,202,130,130,3,3,130,11,130,202,203,201,201,11,135,135,202,130,3,202,202,202,202,202,202,202,3,202,3,135,135,202,20,20,202,201,11,6,6,6,6,6,6,202,203,202,203,130,3,3,3,202,3,3,11,135,130,3,135,135,135,130,3" --><%=FP_FieldVal(fp_rs,"j2sum")%><!--webbot 
    bot="DatabaseResultColumn" endspan --></font></td>
			</tr>
			<tr>
   ...
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j2T"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ></font><font size="1" color="#FFFFFF"> 
			maximum 30</font></td>
			</tr>
		<tr>
				<td style="border-style: none; border-width: medium" width="30%" align="right">
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j2C"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ></font><font size="1" color="#FFFFFF"> 
			maximum 30</font></td>
			</tr>
		<tr>
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j2P"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ></font><font size="1" color="#FFFFFF"> 
			maximum 20</font></td>
			</tr>
		<tr>
   ...
   style="text-align: right; font-family: Bahnschrift; font-size: 10pt; background-color: #EAF4FF" 
   value="<%=formatnumber(FP_FieldVal(fp_rs,"j2M"),0)%>" class="div1" 
   size="6" tabindex="1" maxlength="2" ></font><font size="1" color="#FFFFFF"> 
			maximum 20</font></td>
			</tr>
		<tr>
   ...
   size="6" tabindex="1" maxlength="2" ></font></td>
			</tr>
		<tr>
				<td style="border-style: none; border-width: medium" width="30%" align="right">
				<font color="#FFFFFF">
				...
				<td style="border-style: none; border-width: medium" width="70%" align="left">
			<font color="#FFFFFF">
			<textarea rows="3" name="notes" cols="20" style="font-family: Bahnschrift; font-size: 10pt" tabindex="5" class="div"><%=FP_FieldVal(fp_rs,"j2notes")%> </textarea></font></td>
			</tr>
		<tr>
		<td style="border-style: none; border-width: medium" width="30%" align="left">
		<a target="_self" href="J2_scores.asp?j2ID=<%=FP_FieldURL(fp_rs,"j2ID")%>&category=<%=FP_FieldURL(fp_rs,"category")%>" style="text-decoration: none"><i class="fa-solid fa-magnifying-glass fa-xl" style="color: #ff7600;"></i>
				<font color="#FFFFFF" style="font-size: 9pt">Review</font></a></td>
				<td style="border-style: none; border-width: medium" width="70%" align="left">
			
			<input type="submit" name="B4" id="mySubmit" class="button" value="Submit"></td>
			</tr>
		<tr>
				<td style="border-style: none; border-width: medium" width="30%" align="right">
				&nbsp;</td>
 ...
 align="center">Your browser does not support inline frames or is currently configured not to display inline frames.</iframe>
		...
		<input type="hidden" name="T51" value="<%=FP_FieldVal(fp_rs,"j2sum")%>">
			<script>
