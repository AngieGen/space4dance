...
<div align="center">
	<table border="0" style="border-collapse: collapse" class="spots-number" width=70px>
     ...
     s-sql="SELECT 230-sum(riga_acts) as total from reserved_places" 
...
<% end if %>
<%
fp_sQry="SELECT 230-sum(riga_acts) as total from reserved_places"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
						...
						<!--webbot bot="DatabaseResultColumn" s-columnnames="total" s-column="total" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;total&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"total")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
					</tr>
